...
//
const int SPEED_MAX = 255;  // 255 - maximum PWM
const int SPEED_MIN = 105;  // 105 - minimum PWM for start (for tests value can be lower, e.g.25)
...
byte romana = 0;  // 1 for romana, 0 for english
